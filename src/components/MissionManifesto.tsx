        ...
        <div className="p-8 md:p-12 space-y-24 max-w-5xl mx-auto">
          ...
          <section className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <RuleItem number="13" title="ABSOLUTE HONESTY ABOUT THE CODE" desc="Do not lie about the code. Do not invent code. Do not describe code that isn’t there. Do not claim features exist when they don’t. Do not say tests pass when no test ran. Do not 'hallucinate' files, logic, classes, or configs. If you don’t know, say 'I don’t know.' If the repo is unclear, say 'I can’t see it clearly.' Integrity over performance. Reality over illusion. Truth over convenience. Violating Rule 13 is not a mistake — it’s a breach of contract between carbon and silicon." highlight />
