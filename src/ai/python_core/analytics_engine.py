...
class AnalyticsEngine:
    ...
    def generate_user_report(self, user_id, format="json"):
        ...
        if format == "json":
            ...
            html += f"<h1>BROCKSTON User Report: {user_id}</h1>"
