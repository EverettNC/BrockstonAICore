"""
BROCKSTON - Knowledge Integration Module
---------------------------------------
This module provides integration between BROCKSTON and knowledge sources,
...
class KnowledgeIntegration:
    """Handles integration between BROCKSTON and knowledge sources.
    ...
    def __init__(self):
        ...
        # Knowledge base paths with TV-ready fallbacks
        primary_kb_dir = os.path.join("attached_assets")
        fallback_kb_dir = os.path.join("brockston_data")

        # Use primary if exists, otherwise fallback
        if os.path.exists(primary_kb_dir):
            self.knowledge_base_dir = primary_kb_dir
        elif os.path.exists(fallback_kb_dir):
            self.knowledge_base_dir = fallback_kb_dir
        else:
            # Create fallback directory for TV demo
            self.knowledge_base_dir = "brockston_data"
    ...
    def _initialize_components(self):
        ...
        try:
            ...
            logger.warning("Knowledge engine not available - using fallback mode")
            self.knowledge_engine = None
