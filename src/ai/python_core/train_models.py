...
"""
BROCKSTON - Nonverbal Cue Model Trainer
-------------------------------------
...
The trained models are saved to disk for later use in the BROCKSTON system.
"""
...
def main():
    ...
    logger.info("Starting BROCKSTON nonverbal cue model training...")
...
__all__ = [
    "train_gesture_model",
    "train_vocalization_model",
    "train_eye_movement_model",
    "main",
]
