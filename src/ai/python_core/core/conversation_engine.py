...
"""
Conversation Engine for Brokston

This module implements the conversational intelligence for Brokston, including
...
class ConversationEngine:
    ...
    def _generate_advanced_response(
        ...
        system_prompt = (
            "You are Brokston, a PhD-level AI researcher designed to help with communication, code generation, and autonomous learning. "
