...
# Normalize paths to absolute for robust model loading
...
def debug_inpainting(
    ...
    # Save first frame
    debug_frame_path = os.path.join(args.result_dir, "media/images/debug_frame.png")
    ...
    debug_result_path = os.path.join(args.result_dir, "media/images/debug_result.png")
...
def inference(
    ...
    fps = 25
    # Output video path
    output_video = "media/video/temp.mp4"
    ...
    reader.close()  # Otherwise, error on win11: PermissionError: [WinError 32] Another program is using this file, process cannot access. : 'media/video/temp.mp4'
    ...
    os.remove("media/video/temp.mp4")
...
try:
    ...
    print(f"⚠️  Warning: Audio/Whisper initialization failed: {e}")
