    ...
    for task_id in inference_config:
        try:
            ...
            output_vid_name_concat = os.path.join(
                temp_dir, output_basename + "media/video/_concat.mp4"
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--unet_config",
        type=str,
        default="backend/models/musetalk/config.json",
        help="Path to UNet configuration file",
    )
    parser.add_argument(
        "--unet_model_path",
        type=str,
        default="backend/models/musetalkV15/unet.pth",
        help="Path to UNet model weights",
    )
    parser.add_argument(
        "--whisper_dir",
        type=str,
        default="backend/models/whisper",
